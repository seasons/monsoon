/*
  ...
  - The values [ShippedToCustomer,ShippedToBusiness] on the enum `ReservationPhysicalProductStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ReservationPhysicalProductStatus_new" AS ENUM ('Queued', 'Picked', 'Packed', 'ScannedOnInbound', 'InTransitInbound', 'ScannedOnOutbound', 'InTransitOutbound', 'DeliveredToCustomer', 'DeliveredToBusiness', 'ReturnProcessed', 'ResetEarly', 'Hold', 'Lost');
