/*
  ...
  - A unique constraint covering the columns `[reservation,user]` on the table `ReservationFeedback` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "ReservationFeedback.reservation_user_unique" ON "ReservationFeedback"("reservation", "user");
