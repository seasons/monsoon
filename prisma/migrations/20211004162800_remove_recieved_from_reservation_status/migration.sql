...
-- AlterEnum
BEGIN;
CREATE TYPE "ReservationStatus_new" AS ENUM ('Queued', 'Picked', 'Packed', 'Shipped', 'Delivered', 'Completed', 'Cancelled', 'Hold', 'Blocked', 'Unknown', 'Lost', 'EarlyReturned', 'ReturnPending');
