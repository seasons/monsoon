...
var _1 = require(".");
exports.syncHomepageProductRails = function (cliProgressBar) { return __awaiter(void 0, void 0, void 0, function () {
    var allProductionRecs, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, utils_2.getAllHomepageProductRails(config_1.getProductionBase())];
            case 1:
                allProductionRecs = _c.sent();
                return [4 /*yield*/, _1.deleteAllStagingRecords("Homepage Product Rails", cliProgressBar)];
            case 2:
                _c.sent();
                return [4 /*yield*/, _1.createAllStagingRecordsWithoutLinks({
                        ...
                        sanitizeFunc: function (fields) { return utils_1.Identity(__assign(__assign({}, fields), { Products: [] })); },
                        cliProgressBar: cliProgressBar,
                    })];
            case 3:
                _c.sent();
                _a = addProductsLinks;
                _b = [allProductionRecs];
                return [4 /*yield*/, utils_2.getAllHomepageProductRails(config_1.getStagingBase())];
...
exports.getNumLinksHomepageProductRails = function () { return 1; };
var addProductsLinks = function (allProductionRecords, allStagingRecords, cliProgressBar) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
