...
exports.syncBrands = function (cliProgressBar) { return __awaiter(void 0, void 0, void 0, function () {
    var records, _a, multibar, _cliProgressBar, _i, records_1, record, model, name_1, brandCode, description, website, logo, since, primary, tier, slug, data, brand, e_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                ...
                model = record.model;
                name_1 = model.name, brandCode = model.brandCode, description = model.description, website = model.website, logo = model.logo, since = model.since, primary = model.primary, tier = model.tier;
                ...
                return [4 /*yield*/, prisma_1.prisma.upsertBrand({
                        where: {
                            slug: slug,
                        },
