...
exports.syncColors = function (cliProgressBar) { return __awaiter(void 0, void 0, void 0, function () {
    var records, _a, multibar, _cliProgressBar, _i, records_1, record, model, name_1, colorCode, rGB, slug, data, e_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, utils_1.getAllColors()];
            case 1:
                records = _c.sent();
            ...
            case 4:
                ...
                model = record.model;
                name_1 = model.name, colorCode = model.colorCode, rGB = model.rGB;
                ...
                return [4 /*yield*/, prisma_1.prisma.upsertColor({
                        where: {
                            slug: slug,
                        },
                        create: data,
