...
function updatePhysicalProducts(airtableIDs, fields) {
    return __awaiter(this, void 0, void 0, function () {
        var formattedUpdateData, updatedRecords;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    formattedUpdateData = lodash_1.zip(airtableIDs, fields).map(function (a) {
                        return {
                            id: a[0],
                            fields: a[1],
                        };
                    });
                    return [4 /*yield*/, config_1.base("Physical Products").update(formattedUpdateData)];
                case 1:
                    updatedRecords = _a.sent();
                    return [2 /*return*/, updatedRecords];
            }
        });
    });
}
