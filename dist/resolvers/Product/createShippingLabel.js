...
var activeShippo = shippo_1.default(process.env.SHIPPO_API_KEY);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, activeShippo.transaction
                                    .create(inputs)
                                    .catch(reject)];
                            case 1:
                                transaction = _a.sent();
                                if (transaction.object_state === "VALID" &&
                                    ...
                                    reject(transaction.messages.reduce(function (acc, curVal) {
