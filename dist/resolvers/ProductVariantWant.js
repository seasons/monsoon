...
exports.ProductVariantWantMutations = {
    addProductVariantWant: function (parent, _a, ctx, info) {
        var variantID = _a.variantID;
        return __awaiter(this, void 0, void 0, function () {
            var user, productVariant, productVariantWant;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ctx.prisma.productVariant({ id: variantID })];
                    case 2:
                        productVariant = _b.sent();
                        if (!productVariant) {
                            throw new Error("Unable to find product variant with matching ID");
                        }
                        return [4 /*yield*/, ctx.prisma.createProductVariantWant({
                                isFulfilled: false,
                                productVariant: {
                                    connect: {
                    ...
                    case 3:
                        productVariantWant = _b.sent();
                        return [2 /*return*/, productVariantWant];
                }
            });
        });
    }
