...
type Mutation {
  ...
  updateManyParcels(data: ParcelUpdateManyMutationInput!, where: ParcelWhereInput): BatchPayload!
  upsertParcel(where: ParcelWhereUniqueInput!, create: ParcelCreateInput!, update: ParcelUpdateInput!): Parcel!
  deleteParcel(where: ParcelWhereUniqueInput!): Parcel
  deleteManyParcels(where: ParcelWhereInput): BatchPayload!
...
type ParcelSubscriptionPayload {
  mutation: MutationType!
  node: Parcel
  updatedFields: [String!]
...
input ParcelSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ParcelWhereInput
  AND: [ParcelSubscriptionWhereInput!]
  OR: [ParcelSubscriptionWhereInput!]
  NOT: [ParcelSubscriptionWhereInput!]
}

input ParcelUpdateDataInput {
...
input ParcelUpdateManyMutationInput {
  weight: Float
}

input ParcelUpdateOneInput {
  create: ParcelCreateInput
  update: ParcelUpdateDataInput
  upsert: ParcelUpsertNestedInput
  delete: Boolean
  disconnect: Boolean
  connect: ParcelWhereUniqueInput
}

input ParcelUpsertNestedInput {
  update: ParcelUpdateDataInput!
  create: ParcelCreateInput!
}
...
type Query {
  ...
  parcels(where: ParcelWhereInput, orderBy: ParcelOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Parcel]!
  parcelsConnection(where: ParcelWhereInput, orderBy: ParcelOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ParcelConnection!
...
input ReservationCreateInput {
  ...
  sentParcel: ParcelCreateOneInput
  returnedParcel: ParcelCreateOneInput
...
input ReservationUpdateInput {
  ...
  sentParcel: ParcelUpdateOneInput
  returnedParcel: ParcelUpdateOneInput
...
input ReservationWhereInput {
  ...
  user: UserWhereInput
  customer: CustomerWhereInput
  sentParcel: ParcelWhereInput
  returnedParcel: ParcelWhereInput
  location: LocationWhereInput
...
type Subscription {
  ...
  parcel(where: ParcelSubscriptionWhereInput): ParcelSubscriptionPayload
