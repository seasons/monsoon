...
export interface ProductVariantWhereInput {
  ...
  color?: Maybe<ColorWhereInput>
  size?: Maybe<LetterSize>
  size_not?: Maybe<LetterSize>
  size_in?: Maybe<LetterSize[] | LetterSize>
  size_not_in?: Maybe<LetterSize[] | LetterSize>
...
export interface ProductVariantSubscription
  ...
  size: () => Promise<AsyncIterator<LetterSize>>
