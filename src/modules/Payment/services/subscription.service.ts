...
export class SubscriptionService {
  ...
  async createPrismaSubscription(
    ...
    const updateCustomer = await this.prisma.client.customer.update({
      where: { id: customer.id },
      data: updateData,
      select: {
        id: true,
    ...
    // TODO: make sure shipping options are created here
    await this.customer.addCustomerLocationShippingOptions({
      customer: updateCustomer,
      shippingAddressID: updateCustomer?.detail?.shippingAddressId,
    })
