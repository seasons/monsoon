...
import { CustomerDetailCreateInput, Plan, LocationCreateInput, BillingInfoCreateInput, CustomerStatus, User } from "../prisma"
...
export const createOrUpdateAirtableUser = async (
    ...
    if (!!fields.billingInfo) {
        const airtableBillingInfoRecord = await createBillingInfo(fields.billingInfo)
