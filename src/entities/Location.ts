...
export class Location {
  ...
  @OneToMany(() => Package, package => package.fromAddress)
  packages: Package[]

  @OneToMany(() => Package, package => package.toAddress)
  packages2: Package[]

  @OneToMany(() => PhysicalProduct, physicalProduct => physicalProduct.location)
